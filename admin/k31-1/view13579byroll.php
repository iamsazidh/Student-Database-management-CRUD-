...
if(!$connection){
  ...
  if(isset($_REQUEST['roll'])){
    $rcvd_roll = $_REQUEST['roll'];

    $get_info = "SELECT * FROM `k-31` WHERE roll = $rcvd_roll";
     ...
     <img src="KMC.png" alt="Icon" class="headerkmc">
        ...
        <div class="personal_information">
         ...
         <div class="admission_info">
          ...
          <div class="gurdian">
          <p class="gurdian_s_rel box paddinglf margint">Gurdian Relation: <?php echo $gurdian_s_rel; ?></p>
          <p class="gurdian_f_rel box paddinglf margint">Gurdian Relation: <?php echo $gurdian_f_rel; ?></p>
