...
<!DOCTYPE html>
  ...
  <body>
    ...
    <form action="index.php" method="post" class="search_form">
      <input type="text" class="searchbar" name="search_merit" placeholder="Search Here By Merit">
...
<?php
  ...
  <body>
    ...
    <tr>
      ...
      <td><?php echo   $ad_merit; ?></td>
      <td><?php echo   $ad_roll; ?></td>
...
//without Search
  ...
  $query = "SELECT * FROM `k-31` ORDER BY `k-31`.`ad_merit` ASC";
